...
annulus_in    = aperture_rad + allsigma  # At least 1 std away from aperture
annulus_out   = aperture_rad + 3.0 * allsigma  # A few std away from inside ring

subimage_size = 2 * int(7.0 * allsigma)  # subimage contains all annulus + a little more
